---
layout: lab
module: workflow-email-triage
title: "Workflow-Based Email Triage"
order: 440
duration: 40
difficulty: 200
lab_type: local
...
description: "Build a Copilot Studio workflow that reacts to new inbox messages, classifies them by urgency, turns urgent mail into a short markdown alert, and posts it to Teams - then validate the whole path with a real email."
---
...
- [Instructions by Use Case](#instructions-by-use-case)
  - [Use Case #1: Create the Email Triage Workflow](#use-case-1-create-the-email-triage-workflow)
  - [Use Case #2: Add Classification Logic](#use-case-2-add-classification-logic)
  - [Use Case #3: Add a Prompt for the Urgent Summary](#use-case-3-add-a-prompt-for-the-urgent-summary)
  - [Use Case #4: Add Teams Alert for Urgent Cases](#use-case-4-add-teams-alert-for-urgent-cases)
  - [Use Case #5: Run an End-to-End Workflow Test](#use-case-5-run-an-end-to-end-workflow-test)
- [Summary of learnings](#summary-of-learnings)
- [Next expansion ideas](#next-expansion-ideas)
...
## Use Case #3: Add a Prompt for the Urgent Summary
