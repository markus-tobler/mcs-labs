---
layout: lab
module: app-with-data-extraction
title: "Canvas App with AI Data Extraction"
order: 420
duration: 60
difficulty: 200
lab_type: local
...
description: "Import a Dataverse table, build a prompt that turns unstructured customer feedback into strict JSON, and wire it into a Power Apps canvas app with Predict() and Patch() so the form fills itself as the user types."
---
...
- [Instructions by Use Case](#instructions-by-use-case)
  - [Use Case #1: Import the Table and Build the Prompt](#use-case-1-import-the-table-and-build-the-prompt)
  - [Use Case #2: Wire the Prompt into a Canvas App](#use-case-2-wire-the-prompt-into-a-canvas-app)
