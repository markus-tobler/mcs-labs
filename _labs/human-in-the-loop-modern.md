...
description: "Build an expense claims solution with an agent powered by the GitHub Copilot harness that stores receipts in OneDrive and a workflow that evaluates each claim against policy with an inline agent, routes higher-value claims to a human reviewer, and emails the requestor the final outcome."
---
